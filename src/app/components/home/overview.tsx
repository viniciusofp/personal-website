    ...
    >
      <div className="rounded-xl p-6 md:p-3 flex flex-col gap-3 md:gap-5 lg:gap-8 leading-relaxed text-center max-w-xl">
        ...
        <div className="flex gap-3 justify-center items-center">
          <Link
            href="https://www.linkedin.com/in/vin%C3%ADcius-pereira-80528a82/"
            target="_blank"
          >
            <Button
              size="sm"
            ...
            >
              <Linkedin className="!size-3.5 text-stone-600" />
              Linkedin
            </Button>
          </Link>
          <Link href="https://wa.me/5511976970327" target="_blank">
            <Button
              size="sm"
              variant={'outline'}
              className="gap-2 items-center"
            >
              <svg
                ...
                viewBox="0 0 308 308"
                xmlSpace="preserve"
                className="!size-3.5 fill-stone-600"
              >
                <g id="XMLID_468_">
                  <path
                    id="XMLID_469_"
